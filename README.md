...
- **Advanced metrics**: Module independence, blast radius, instability (Martin's I), abstractness (Martin's A), distance from main sequence (Martin's D), dependency depth, violation age
